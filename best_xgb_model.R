...
rf <- randomForest(as.factor(TARGET) ~ ., data = train_rf)
preds_1 <- predict(rf, test_rf)
...
preds_1[nv > 0] = 0
preds_1[tc['var15'] < 23] = 0
preds_1[tc['saldo_medio_var5_hace2'] > 160000] = 0
preds_1[tc['saldo_var33'] > 0] = 0
preds_1[tc['var38'] > 3988596] = 0
preds_1[tc['var21'] > 7500] = 0
preds_1[tc['num_var30'] > 9] = 0
preds_1[tc['num_var13_0'] > 6] = 0
preds_1[tc['num_var33_0'] > 0] = 0
preds_1[tc['imp_ent_var16_ult1'] > 51003] = 0
preds_1[tc['imp_op_var39_comer_ult3'] > 13184] = 0
preds_1[tc['saldo_medio_var5_ult3'] > 108251] = 0
preds_1[(tc['var15']+tc['num_var45_hace3']+tc['num_var45_ult3']+tc['var36']) <= 24] = 0
preds_1[tc['saldo_var5'] > 137615] = 0
